...
/**
 * Pulls in the events posts from the query get_events_query() and then
 * returns an array with their post meta.
 *
 * @return array If evemts posts do exist then it will return an array of the posts with their post meta, otherwise it will return false.
 */
function get_events() {
