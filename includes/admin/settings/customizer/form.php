...
function form( WP_Customize_Manager $manager  ) {
	$manager->add_section( 'form_section', [
		'title' => esc_html__( 'Form', 'atu' ),
	]);

	$manager->add_setting( 'form_settings[subheading]', [
		'type'      => 'theme_mod',
		'transport' => 'postMessage',
	]);

	$manager->add_control( 'form_settings[subheading]', [
		'label'   => esc_html__( 'Sub Heading', 'atu' ),
		'section' => 'form_section',
		'type'    => 'text',
	]);

	$manager->add_setting( 'form_settings[heading]', [
		'type'      => 'theme_mod',
		'transport' => 'postMessage',
	]);

	$manager->add_control( 'form_settings[heading]', [
		'label'   => esc_html__( 'Heading', 'atu' ),
		'section' => 'form_section',
		'type'    => 'text',
	]);

	$manager->add_setting( 'form_settings[description]', [
		'type'      => 'theme_mod',
		'transport' => 'postMessage',
	] );

	$manager->add_control( 'form_settings[description]', [
		'label'   => esc_html__( 'Form Description', 'atu' ),
		'section' => 'form_section',
		'type'    => 'textarea',
	]);

	$manager->add_setting( 'form_settings[id]', [
		'type'      => 'theme_mod',
		'transport' => 'postMessage',
	]);

	$manager->add_control( 'form_settings[id]', [
