<?php
/**
 * File contains the hero customizer controls;
 *
 * @package atu-theme
 */
...
function hero( WP_Customize_Manager $manager ) {
	...
	$manager->add_setting(
		'hero_settings_slide1[subheading]',
		[
			'type'      => 'theme_mod',
	...
	$manager->add_setting(
		'hero_settings_slide2[subheading]',
		[
			'type'      => 'theme_mod',
			'transport' => 'postMessage',
		]
