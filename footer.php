<?php
/**
 * File contains html code for the footer
 *
 * @package atu-theme
 */
			...
			<div class="container">
				<div class="footer-bottom-wrapper">
					<div class="footer-bottom-text-wrapper">
						<span class="footer-copyright">©<?php echo esc_html( date( 'Y' ) ); ?>
						<?php esc_html_e( 'Athlete Transition U', 'atu' ); ?></span>
						<?php
