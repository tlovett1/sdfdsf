<?php
/**
 * Partial file for the about list section
 *
 * @package atu-theme
 */
...
use ATU\Theme\Views;
?>
<div id="aboutList" class="about-list-section section block" style="background-image:url(<?php echo esc_url( wp_get_attachment_url( $settings['image'] ) ? wp_get_attachment_url( $settings['image'] ) : null ); ?>)">
